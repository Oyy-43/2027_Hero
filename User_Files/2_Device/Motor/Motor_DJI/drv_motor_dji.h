#ifndef __DRV_MOTOR_DJI_H__
#define __DRV_MOTOR_DJI_H__
 ...
 *
 */
enum Enum_Motor_DJI_Motor_Type
{
    Motor_DJI_Motor_Type_GM6020 = 0,
    Motor_DJI_Motor_Type_C620,
    Motor_DJI_Motor_Type_C610,
};
...
/**
 * @brief Reusable, GM6020无刷电机, 单片机控制输出电压, 新驱动支持电流控制
 *
 */
class Class_Motor_DJI_GM6020
{
public:
    _PID_TypeDef PID_Angle;

    _PID_TypeDef PID_Omega;
...
protected:
    ...
    //速度环控制频率
    uint16_t Speed_Loop_Frequency = 500;

    //位置环控制频率
    uint16_t Position_Loop_Frequency = 250;
