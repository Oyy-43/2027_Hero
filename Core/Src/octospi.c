...
void HAL_OSPI_MspDeInit(OSPI_HandleTypeDef* ospiHandle)
{
  ...
  /* USER CODE END OCTOSPI2_MspDeInit 0 */
    ...
    PE11     ------> OCTOSPIM_P1_NCS
    */
    HAL_GPIO_DeInit(GPIOE, W25Q64_SI__OSPI_IO0_Pin|W25Q64_CS__OSPI_NCS_Pin);

    HAL_GPIO_DeInit(W25Q64_CLK__OSPI_CLK_GPIO_Port, W25Q64_CLK__OSPI_CLK_Pin);

    HAL_GPIO_DeInit(GPIOA, W25Q64_HOLD__OSPI_IO3_Pin|W25Q64_WP__OSPI_IO2_Pin);

    HAL_GPIO_DeInit(W25Q64_SO__OSPI_IO1_GPIO_Port, W25Q64_SO__OSPI_IO1_Pin);
